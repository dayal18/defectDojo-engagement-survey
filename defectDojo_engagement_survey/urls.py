...
urlpatterns = [
    ...
    url(r'^new_questionnaire$',
        views.add_empty_survey,
        name='add_empty_survey'),
    url(r'^new_questionnaire/(?P<esid>\d+)$',
        views.view_empty_survey,
        name='view_empty_survey'),
    url(r'^new_questionnaire/(?P<esid>\d+)/delete$',
    ...
    url(r'^new_questionnaire/(?P<esid>\d+)/answer$',
        views.answer_empty_survey,
        name='answer_empty_survey'),
    url(r'^new_questionnaire/(?P<esid>\d+)/new_engagement$',
